...
"""
Adapting mono_inertial_driver_node for playing back tank dataset
...
class MonoDriver(Node):
    def __init__(self, node_name = "mono_py_node"):
        ...
        self.home_dir = str(Path.home()) + "/ws_blue/src/slam-wrapper-v2" #! Change this to match path to your workspace
        self.parent_dir = "../../data/short_test" #! Change or provide path to the parent directory where data for all image sequences are stored
        ...
        self.imgz_seqz, self.time_seqz = self.get_image_dataset(self.image_sequence_dir) 
    ...
    # ****************************************************************************************
    def get_image_dataset(self, imgz_file_dir):
        """
            Returns images and list of timesteps in ascending order from a ASL formatted dataset

        ### Parameters
        1. exp_dir : str
            - directory of image sequences

        ### Returns
        - imgz_file_list
            - List of strings, each the name of an image file
        - time_list
            - List for strings, each the timestamp of an image in ns
        """
        ...
        return imgz_file_list, time_list
    # ****************************************************************************************
    ...
    def run_py_node(self, idx, imgz_name):
        ...
        # Path to this image
        img_look_up_path = self.image_sequence_dir  + "/" + imgz_name
