...
namespace ORB_SLAM3 {
    ...
    bNeedToUndistort_(false), bNeedToRectify_(false), bNeedToResize1_(false), bNeedToResize2_(false) {
        ...
        if(sensor_ == System::STEREO || sensor_ == System::IMU_STEREO || sensor_ == System::IMU_DVL_STEREO){
        ...
        if(sensor_ == System::IMU_MONOCULAR || sensor_ == System::IMU_STEREO || sensor_ == System::IMU_RGBD || sensor_ == System::IMU_DVL_STEREO){
            readIMU(fSettings);
    ...
    void Settings::readImageInfo(cv::FileStorage &fSettings) {
        ...
        if(found){
            ...
            if(!bNeedToRectify_){
                ...
                if((sensor_ == System::STEREO || sensor_ == System::IMU_STEREO || sensor_ == System::IMU_DVL_STEREO) && cameraType_ != Rectified){
    ...
    void Settings::precomputeRectificationMaps() {
        ...
        if(sensor_ == System::IMU_STEREO || sensor_ == System::IMU_DVL_STEREO){
    ...
    ostream &operator<<(std::ostream& output, const Settings& settings){
        ...
        if ((settings.sensor_ == System::STEREO || settings.sensor_ == System::IMU_STEREO || settings.sensor_ == System::IMU_DVL_STEREO) && (settings.cameraType_ !=  Settings::Rectified))
        {
        ...
        if(settings.bNeedToRectify_){
            ...
            if(settings.sensor_ == System::STEREO || settings.sensor_ == System::IMU_STEREO || settings.sensor_ == System::IMU_DVL_STEREO){
        ...
        if(settings.sensor_ == System::IMU_MONOCULAR || settings.sensor_ == System::IMU_STEREO || settings.sensor_ == System::IMU_RGBD || settings.sensor_ == System::IMU_DVL_STEREO){
