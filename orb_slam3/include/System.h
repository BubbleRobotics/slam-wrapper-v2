...
public:
    ...
    // Uses TrackStereo but also gives back the pose covariance matrix
    std::pair<Sophus::SE3f, Eigen::Matrix<float, 6, 6>> TrackWithCovariance(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp);
