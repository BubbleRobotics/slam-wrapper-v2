...
//* Includes
#include "ros2_orb_slam3/mono_inertial_node.hpp"

//* Constructor
MonocularInertialMode::MonocularInertialMode() :Node("mono_node_cpp")
{
    ...
    homeDir = getenv("HOME");
    packagePath = "ws_blue/src/slam-wrapper-v2/"; // !HARDCODED, change it as necessary
    ...
    expConfig_subscription_ = this->create_subscription<std_msgs::msg::String>(subexperimentconfigName, 1, std::bind(&MonocularInertialMode::experimentSetting_callback, this, _1));
    ...
    subImgMsg_subscription_= this->create_subscription<sensor_msgs::msg::Image>(subImgMsgName, 1, std::bind(&MonocularInertialMode::Img_callback, this, _1));

    //* subscribe to receive the timestep
    subTimestepMsg_subscription_= this->create_subscription<std_msgs::msg::Float64>(subTimestepMsgName, 1, std::bind(&MonocularInertialMode::Timestep_callback, this, _1));
...
void MonocularInertialMode::Img_callback(const sensor_msgs::msg::Image& msg)
{
    // Initialize
